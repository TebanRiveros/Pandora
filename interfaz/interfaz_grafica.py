...
class VentanaSimulacion():
    def __init__(self):
        ...
        self.button_sensor = ctk.CTkButton(self.menu)
        self.button_acondicionador = ctk.CTkButton(self.menu)
        self.button_discretizador = ctk.CTkButton(self.menu)
        self.button_emulador = ctk.CTkButton(self.menu)
